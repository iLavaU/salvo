...
public class Util {
    ...
    public static int getAllHistoricShipHits(GamePlayer gamePlayer){
        int allHits = gamePlayer.getShips()
                .stream()
    ...
    public static String getGameState(GamePlayer gamePlayer) {
        ...
        int allEnemyHits = Util.getAllHistoricShipHits(gamePlayer);
        int allMyHits = Util.getAllHistoricShipHits(opponent);
